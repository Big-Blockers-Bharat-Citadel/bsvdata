...
exports.compileContract =
  exports.sendTx =
  exports.newTx =
  exports.inputSatoshis =
  exports.inputIndex =
    void 0;
var path = require("path");
var _a = require("fs"),
  readFileSync = _a.readFileSync,
  existsSync = _a.existsSync,
  mkdirSync = _a.mkdirSync;
var _b = require("scryptlib"),
  bsv = _b.bsv,
  compileContractImpl = _b.compileContract,
  getPreimage = _b.getPreimage,
  toHex = _b.toHex;
...
var sighashType2Hex = function (s) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            axios.post("".concat(API_PREFIX, "/tx/raw"), {
              txhex: hex,
            }),
          ];
        case 2:
...
function compileContract(fileName, options) {
  ...
  var result = compileContractImpl(
    filePath,
    options
      ? options
      : {
  ...
  if (result.errors.length > 0) {
    console.log(
      "Compile contract ".concat(filePath, " failed: "),
      result.errors
    );
    throw result.errors;
  }
...
function loadDesc(fileName) {
  ...
  if (!fileName.endsWith(".json")) {
    ...
    if (!existsSync(filePath)) {
      filePath = path.join(
        __dirname,
        "out/".concat(fileName, "_debug_desc.json")
      );
    }
  } else {
...
function checkLowS(tx, lockingScript, inputSatoshis, inputIndex) {
  ...
  var sighash = bsv.crypto.Hash.sha256sha256(
      ...
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            axios.get(
              "".concat(API_PREFIX, "/address/").concat(address, "/unspent")
            ),
          ];
        case 1:
          utxos = _a.sent().data;
